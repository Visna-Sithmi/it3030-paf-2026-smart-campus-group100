  ...
  return (
    <div className="min-h-screen bg-[#eef2f6]">
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-[#002147]">Issue Overview</h2>
          <p className="text-slate-600">Handle and resolve campus issues</p>
        </div>

        <div className="mb-8 grid gap-6 md:grid-cols-3">
          <div className="rounded-xl bg-white p-6 shadow-md">
            <h3 className="text-sm font-semibold uppercase text-slate-500">Open Issues</h3>
            <p className="text-3xl font-bold text-[#002147]">0</p>
          </div>
          <div className="rounded-xl bg-white p-6 shadow-md">
            <h3 className="text-sm font-semibold uppercase text-slate-500">In Progress</h3>
            <p className="text-3xl font-bold text-[#002147]">0</p>
          </div>
          <div className="rounded-xl bg-white p-6 shadow-md">
            <h3 className="text-sm font-semibold uppercase text-slate-500">Resolved</h3>
            <p className="text-3xl font-bold text-[#002147]">0</p>
          </div>
        </div>
